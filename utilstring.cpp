...
namespace util {
	 ...
	 *=========================================================================*/
	 ...
	 /** Default Constructor */
	string::string() { intialize_string(INITIAL_SIZE); }
	...
	string::string(const char* charArray) {
		// ensure string is initialized before using it
		intialize_string(rawSize(charArray));
		// copy passed array to the string
		deepCopy(charArray);
	}
	//-------------------------------------------------------------
	...
	string::string(const std::string& std_string) {
		// ensure string is initialized before using it
		intialize_string(rawSize(std_string.c_str()));
		// copy passed array to the string
		deepCopy(std_string.c_str());
	}
	//-------------------------------------------------------------
	...
	string::string(const string& data) {
		// ensure string is initialized before using it
		intialize_string(rawSize(data.c_str()));
		// copy passed array to the string
		deepCopy(data.c_str());
	}
	...
	*/
	...
	string string::substr(size_t start_position, size_t length) {
		// make sure the required length does not exeed the number of characters
		// already in the string
		size_t string_length = size();
		if ((start_position + length) > string_length) {
			length = string_length - start_position;
		}
