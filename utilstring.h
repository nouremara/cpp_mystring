...
namespace util {
    ...
    class string {
       ...
       public:
        ...
        //void concat(char* rawCharTarget, const char* rawCharSource, size_t startPosition = 0);
    ...
    void deepCopy(char* rawCharTarget, const char* rawCharSource, size_t destStartPosition = -1, size_t srcEndPosition = -1);
